...
* К файлу дизайн-макета прилагать скрин макета в формате .pdf для более быстрого просмотра содержимого макета
* Все элементы, относящиеся к оформлению сайта (различные иконки, стрелочки, крестики и т.п.), предоставляются в векторном формате .ai (Adobe Illustrator)
* Для всех элементов в векторном формате необходимо будет предоставить копии в формате .png или .jpg

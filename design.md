...
Слои (layers)
-------------
* Каждый элемент должен находится в одном слое, названным человечески-понятным именем, а не «slice 1,2». Запрещено использовать слои с названием вида «Layer N» или «Layer N copy copy»
